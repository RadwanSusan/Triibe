    ...
    if (isset($_SESSION["userid"])) {
        ...
        '
                        <form class="d-flex" action="../home.php" method="post">
                            <button class="btn mt-2 mr-2 mb-2" type="submit" id="btn-logout" style="background: radial-gradient(50% 50% at 50% 50%, var(--main-color) 30%, var(--alt-color) 150%); border-radius: 100px; width: 200px; color: white; font-size: 16px;">الرجوع إلى الصفحة الرئيسية</button>
                        </form>
                    ';
    }

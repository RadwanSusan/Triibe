        ...
        <div class="p-3 py-5 justify-content-center">
            ...
            <div class="row mt-2">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" id="address" name="address" value="<?php echo $row['address']; ?>" <?php
                                                                                                                                if (!isset($_POST["sub1"])) {
                                                                                                                                    echo 'disabled';
                                                                                                                                } else {
            ...
            <div class="row mt-2">
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" <?php
                                                            ...
                                                            ?> value="<?php echo $row['mobile']; ?>" name="mobile">
                </div>
                <div class="col-md-4">
                    <label class="labels mt-1">التوجه الدراسي<sub> (ساعات) </sub></label>
                    <select class="form-control" name="std_hr" id="std_gr" <?php
                                                                            if (!isset($_POST["sub1"])) {
                                                                                echo 'disabled';
                                                                            } else {
                                                                                echo 'style="box-shadow: 0px 0px 8px 4px var(--main-color);"';
                ...
                <div class="col-md-4">
                    ...
                    <select class="form-control" name="std_dy" id="std_dy" <?php
                                                                            if (!isset($_POST["sub1"])) {
                                                                                echo 'disabled';
                                                                            } else {
                                                                                echo 'style="box-shadow: 0px 0px 8px 4px var(--main-color);"';
